...
function getSecret() {
  return process.env.ESPACE_PRO_SESSION_SECRET || process.env.ADMIN_API_KEY || 'dev_espace_pro_secret';
}

export function createEspaceProToken(accountId) {
  const payload = {
...
export function verifyEspaceProToken(token) {
