...
export const trainingPrograms: Program[] = [
  {
    ...
    description:
      "Maîtrisez React avec les hooks avancés, la gestion d'état moderne et l'optimisation des performances pour créer des applications web robustes et évolutives.",
    sessions: [
      {
        id: "react-session-1",
  ...
  },
  {
    ...
    description:
      "Apprenez à analyser, visualiser et modéliser des données avec Python, pandas, scikit-learn et les techniques avancées de Machine Learning.",
    sessions: [
      {
        id: "data-session-1",
  ...
  },
  {
    ...
    description:
      "Développez vos compétences en leadership stratégique, gestion d'équipe et prise de décision pour exceller dans vos responsabilités managériales.",
    sessions: [
      {
  ...
  },
  {
    ...
    description:
      "Créez des expériences utilisateur exceptionnelles et des interfaces modernes avec Figma, les principes de design et les méthodologies UX.",
    sessions: [
      {
        id: "design-session-1",
  ...
  },
  {
    ...
    description:
      "Maîtrisez les stratégies marketing modernes, l'acquisition client, l'analyse de données marketing et les techniques de croissance rapide.",
    sessions: [
      {
  ...
  },
  {
    ...
    description:
      "Automatisez vos déploiements, maîtrisez Docker, Kubernetes, AWS et les pratiques DevOps pour des infrastructures modernes et scalables.",
    sessions: [
      {
        id: "devops-session-1",
