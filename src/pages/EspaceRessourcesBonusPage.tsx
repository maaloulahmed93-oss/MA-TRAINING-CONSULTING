...
const EspaceRessourcesBonusPage: React.FC = () => {
  const navigate = useNavigate();

  const items = useMemo(
    () => ESPACE_RESSOURCES_ITEMS.filter((x) => x.variant === "bonus"),
    []
  );
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 flex items-center justify-between gap-3">
                    <button
                      type="button"
                      onClick={() => navigate(`/espaces-ressources/bonus/${it.slug}`)}
...
export default EspaceRessourcesBonusPage;
