...
import SharedFormWizard from './SharedFormWizard';

void ProgrammeManager;
void SeanceManager;
void ParticipantManager;
void EvenementManager;
void formateurProgrammeService;
void SharedFormWizard;
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Document interne (lecture uniquement)</p>
            </div>
